...
def books_list():
    ...
    return render_template('rgz/books_list.html', books=books, page=page, total_pages=total_pages, filters=request.args)
...
def add_book():
    if request.method == 'POST':
        ...
        conn = get_db_connection()
        conn.execute('INSERT INTO books (title, author, pages, publisher) VALUES (?, ?, ?, ?)',
